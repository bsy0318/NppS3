...
const wchar_t* const kEN[N] = {
    ...
    L"Access Key ID",
    L"Secret Access Key",
    L"Stored securely in Windows Credential Manager.",
    L"Default Bucket",
    L"Default Prefix",
    ...
    L"A Secret Access Key is required.",
...
const wchar_t* const kKO[N] = {
    ...
    L"Access Key ID",
    L"Secret Access Key",
    L"Windows 자격 증명 관리자에 안전하게 저장됩니다.",
    L"기본 버킷",
    L"기본 접두사",
    L"Path-style 주소 지정",
    L"저장 시 자동 업로드",
...
const wchar_t* const kJA[N] = {
    ...
    L"Access Key ID",
    L"Secret Access Key",
    L"Windows 資格情報マネージャーに安全に保存されます。",
    L"既定のバケット",
    L"既定のプレフィックス",
    L"パス形式アドレス",
    L"保存時に自動アップロード",
...
const wchar_t* const kRU[N] = {
    ...
    L"Access Key ID",
    L"Secret Access Key",
    L"Надёжно хранится в Диспетчере учётных данных Windows.",
    ...
    L"Secret Access Key обязателен.",
